...
// Increment video views
// (POST /api/videos/{id}/view)
func (_ Unimplemented) IncrementVideoViews(w http.ResponseWriter, r *http.Request, id openapi_types.UUID) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// IncrementVideoViews operation middleware
func (siw *ServerInterfaceWrapper) IncrementVideoViews(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.IncrementVideoViews(w, r, id)
	}))
